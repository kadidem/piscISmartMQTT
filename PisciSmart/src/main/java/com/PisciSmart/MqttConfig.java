...
public class MqttConfig {
    ...
    public MqttClient mqttClient() throws Exception {
        ...
        MqttClient client = new MqttClient("tcp://13.48.194.11:1883", MqttClient.generateClientId(), new MemoryPersistence());
        ...
        System.out.println("Vous êtes connecté au broker: tcp://13.48.194.11:1883");
