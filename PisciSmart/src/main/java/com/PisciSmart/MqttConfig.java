...
public class MqttConfig {
    ...
    public MqttClient mqttClient() throws Exception {
        ...
        MqttClient client = new MqttClient("tcp://51.20.7.45:1883", MqttClient.generateClientId(), new MemoryPersistence());
        ...
        System.out.println("Vous êtes connecté au broker: tcp://51.20.7.45:1883");
